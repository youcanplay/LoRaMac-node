...
//    printf( "###### ===== ClassA demo application v1.0.RC1 ==== ######\r\n\r\n" );
    ...
    //uint8_t reg = SX1276Read(REG_LR_VERSION);	//test sx127x read register
